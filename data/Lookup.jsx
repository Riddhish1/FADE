...
`
  ...
  PRICING_DESC: 'Choose the plan that fits your needs. Scale your development with FADE\'s powerful AI tools and unlock higher productivity.',
  PRICING_OPTIONS: [
    {
      name: 'Free',
      tokens: '35K',
      value: 35000,
      desc: 'Perfect for testing and small personal projects with essential features.',
      price: 0.00,
      features: [
    ...
    },
    {
      ...
      tokens: '150K',
      value: 150000,
      desc: 'For developers working on multiple projects with advanced customization.',
      price: 9.99,
      features: [
    ...
    },
    {
      ...
      tokens: '2.5M',
      value: 2500000,
      desc: 'For professional developers and small teams needing extensive features.',
      price: 19.99,
      features: [
        'Premium code optimization',
    ...
    },
    {
      ...
      tokens: 'Unlimited',
      value: 999999999,
      desc: 'Custom solution for teams and businesses with dedicated support.',
      price: 49.99,
      features: [
        'All Pro features',
